    ...
    FilmRoll.prototype.configure = function() {
      ...
      if (this.options.prev !== false) {
        if (this.options.prev && this.options.next) {
          ...
          this.wrapper.append('<a class="film_roll_prev" href="#"><i class="fas fa-chevron-circle-left"></i></a>');
      ...
      if (this.options.next !== false) {
        if (this.options.next) {
          ...
          this.wrapper.append('<a class="film_roll_next" href="#"><i class="fas fa-chevron-circle-right"></i></a>');
